        ...
        private IEnumerator DoStoryAction(int num)
        {
            if (!_isStoryProgressing)
            {
                ...
                else if (num == 10)
                {
                    ...
                    StartCoroutine(AppendTextOneByOne(_story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>(), "< 코스모스 세기 2354년, 인류는 업화의 불길에 휩싸였다. >\n\n", 1));
                ...
                {
                    SetDialogOn(false);
                    StartCoroutine(AppendTextOneByOne(_story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>(), "< 튜토리얼을 시작합니다. >\n\n", 1));
                    yield return new WaitForSeconds(2);
                    StartCoroutine(AppendTextOneByOne(_story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>(), "< 먼저 B 키를 눌러, 눈앞의 무기를 장착해보세요. >\n\n", 1));
                    yield return new WaitForSeconds(2.5f);
                ...
                else if (num == 22)
                {
                    ...
                    _story.transform.Find("Episode/EpisodeBackground").GetComponent<Image>().sprite = _episodeBackgroundImage.backgroundArray[2];
                    yield return new WaitForSeconds(2f);
                    StartCoroutine(AppendTextOneByOne(_story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>(), "< 무기 장착에 성공했습니다. >\n\n", 1));
                ...
                else if (num == 28)
                {
                    ...
                    StartCoroutine(AppendTextOneByOne(_story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>(), "< 전투 발생! 전투 발생! >\n\n", 1));
                    yield return new WaitForSeconds(2);
                    _story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>().text += "</color>";
                    StartCoroutine(AppendTextOneByOne(_story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>(), "< 야생의 푸니젤리가 나타났다! >\n\n", 1));
                    yield return new WaitForSeconds(2);
                    SetDialogOn(true);
                }
                else if (num == 29)
                ...
                else if (num == 30)
                {
                    SetDialogOn(false);
                    _audioManager.StopBGM();
                    StartCoroutine(AppendTextOneByOne(_story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>(), "< 탕!! >\n\n", 1));
                    _audioManager.PlaySFX("8bitBang");
                    yield return new WaitForSeconds(2);
                    StartCoroutine(AppendTextOneByOne(_story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>(), "< 명중, 당신의 캐릭터가 즉사했다. >\n\n", 1));
                ...
                else if (num == 36)
                {
                    SetDialogOn(false);
                    yield return new WaitForSeconds(2);
                    StartCoroutine(AppendTextOneByOne(_story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>(), "< 오류 발생! 오류 발생! >\n\n", 1));
                    _audioManager.StopBGM();
                    _audioManager.PlaySFX("RobotTalk");
                    yield return new WaitForSeconds(2);
                    StartCoroutine(AppendTextOneByOne(_story.transform.Find("Episode/WindowText").GetComponent<TMP_Text>(), "< 심각한 오류 발생으로 시스템을 긴급 정지합니다. >\n\n", 1));
                    _audioManager.PlaySFX("RobotTalk");
                    yield return new WaitForSeconds(2);
                    ShowSelection("“!?”");
                }
